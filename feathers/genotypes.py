...
TabularGenotype = namedtuple('TabularGenotype', 'architecture')
...
GENOTYPE = Genotype(normal=[('sep_conv_3x3', 0), ('dil_conv_5x5', 1), ('sep_conv_3x3', 2), ('dil_conv_3x3', 0), ('max_pool_3x3', 0), ('dil_conv_3x3', 2), ('dil_conv_5x5', 2), ('avg_pool_3x3', 0)], normal_concat=range(2, 6), reduce=[('skip_connect', 1), ('dil_conv_5x5', 0), ('skip_connect', 0), ('dil_conv_3x3', 1), ('max_pool_3x3', 3), ('sep_conv_3x3', 1), ('max_pool_3x3', 4), ('max_pool_3x3', 3)], reduce_concat=range(2, 6)) # HANF
...
GENOTYPE = TabularGenotype(architecture=['sigmoid_2_reddim', 'tanh_ln_1', 'tanh_ln_1'])
