...
class HANFStrategy(fl.server.strategy.FedAvg):
    ...
    def aggregate_fit(
        ...
        # add distribution and hyperparameters sent to the clients
        serialized_dist = ndarray_to_proto(self.distribution) # NOTE HANF!
        serialized_hyperparams = ndarray_to_proto(self.hyperparams) # NOTE: HANF!
    ...
    def initialize_parameters(self, client_manager: fl.server.client_manager.ClientManager):
        ...
        """
        serialized_hyperparams = ndarray_to_proto(self.hyperparams).ndarray # NOTE: Change to distribution for HANF!
        serialized_dist = ndarray_to_proto(self.distribution).ndarray # NOTE: Change to dist for HANF!
        self.initial_parameters.tensors.append(serialized_dist)
        self.initial_parameters.tensors.append(serialized_hyperparams)
